...
% FORMAT
% DESC plots a hierarchical scatter plot for a hierarchical latent
% variable model.
% ARG model : the model for which the scatter plot is being shown.
% ARG lbls : the labels of the data for the plot (if any).
