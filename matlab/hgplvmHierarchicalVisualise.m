...
% spaces) is also produced here.
% ARG model : the model to be visualised.
% ARG visualiseNodes : structure containing all the relevant information for visualisation.
% ARG dependencyInfo :
% RETURN displayAxes : the axes handle where the visualisation is displayed.
%
% SEEALSO : hgplvmCreate, hgplvmLatentSpaceHandler, fgplvmVisualise
%
