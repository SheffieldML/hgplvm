...
% FORMAT
% DESC Compute the gradients of the log likelihood of the hierarchical
% GP-LVM modea Gaussian with respect to the latent points in the
% GP-LVM model.
% ARG model : the GP model for which log likelihood is to be
% computed.
% RETURN gX : the gradients with respect to latent points.
%
