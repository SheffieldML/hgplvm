...
% FORMAT
% DESC takes a hierarchical GP-LVM structure and a vector of parameters, and
...
% ARG model : the HGPLVM structure to put the parameters in.
% ARG params : parameter vector containing the parameters to put in
% the HGPLVM structure.
% 
% COPYRIGHT : Neil D. Lawrence, 2007
% 
% SEEALSO : hgplvmCreate, hgplvmExtractParam, modelExpandParam
